...
public class GenorateComplete
{
    ...
    readonly string[] imageFileExtentions = { ".png", ".jpg", ".tif" };
    readonly string[] videoFileExtentions = { ".mp4" };
    readonly string[] textFileExtention = { ".json", ".txt", ".csv" };
    ...
    void HandleAssets(string _path)
    {
        foreach (string file in Directory.GetFiles(_path))
        {
            ...
            {
                AddAsset(new Asset(assetIndex, fileName, title, AssetTypes.Text));
            }
